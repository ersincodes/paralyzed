...
export const loadingStates = [
  ...
  {
    text: "Develop and Launch",
  },
  {
    text: "Now, please close this modal and keep scrolling..",
  },
];

//Text Generate Effect Words

export const words = "Experience the New Era";
export const words2 = "Your Future Website";

//Flip Words

export const flipWords = ["Innovation", "Inspiration", "Motivation"];
